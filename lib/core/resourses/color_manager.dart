...
class AppColor {
  ...
  static Color black38 = const Color.fromARGB(97, 0, 0, 0);
  static Color black45 = const Color.fromARGB(115, 0, 0, 0);
  static Color grey = const Color.fromARGB(255, 224, 224, 224);
